    ...
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-2">
      ...
      {totals.overdue > 0 && (
        <button
          ...
          className="px-2 py-1 rounded-full text-xs min-w-[80px] text-center inline-block bg-red-100 text-red-700 hover:bg-red-200 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-1"
        >
